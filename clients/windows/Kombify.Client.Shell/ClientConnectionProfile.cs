...
public sealed record ClientOidcProfile
{
...
public sealed record ClientSyncProfile
{
...
public sealed class ClientProfileException(string message) : Exception(message);

public static partial class ClientConnectionProfileValidator
{
    ...
    public static ClientConnectionProfile ParseAndValidate(string json, Uri configuredEndpoint)
    {
        ...
        {
            throw new ClientProfileException("The selected instance does not advertise ClientConnectionProfile version 1.");
        }
