-- Publish the generation-correlated IONOS create and certified read-only
-- Operator Reconcile adapter. The successor keeps both managed providers in
-- one exact, adapter-pinned catalog.
...
SELECT
    ...
    CASE profile.provider_id
        WHEN 'ionos' THEN 'sha256:e0f5a42df4a0570081b480adcda8b5bba87b395683c160c987af256247c93089'
...
BEGIN
    ...
    WHERE catalog_version = 'managed-vps-2026-08-09.4';
    ...
    WHERE catalog_version = 'managed-vps-2026-08-09.4'
      ...
      AND (
          (
              ...
              AND adapter_manifest_hash = 'sha256:e0f5a42df4a0570081b480adcda8b5bba87b395683c160c987af256247c93089'
          ) OR (
              provider_id = 'centron'
...
WHERE status = 'active'
  AND catalog_version <> 'managed-vps-2026-08-09.4';
